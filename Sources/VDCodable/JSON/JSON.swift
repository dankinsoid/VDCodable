...
public enum JSON: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .number(let d): try singleContainer.encode(d)
    ...
    func putSelf(to encoder: inout ProtobufJSONEncoder) {
        ...
        case .number(let number): encoder.putDecimalValue(value: number)
...
extension JSON {
    ...
    public var int: Int? {
        ...
        case .number(let d):   return Int((d as NSDecimalNumber).intValue)
        default: return nil
        }
    }
    ...
    public var double: Double? {
        switch self {
        case .number(let d):  return (d as NSDecimalNumber).doubleValue
    ...
    public var bool: Bool? {
        ...
        case .number(let i): if i == 1 || i == 0 { return i == 1 }
        default: return nil
        }
        return nil
    }
...
extension JSON: Hashable {
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        case .number(let d): d.hash(into: &hasher)
